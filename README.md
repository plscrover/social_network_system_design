...
|-------------------|-------------------|---------|----------------|---------------------|-----------|---------------|
| Posts (POST)      |        10 000 000 |     120 |          10 KB |     10M | 10s       |     15 MB |         43.2G |
| Posts (GET)       |       100 000 000 |    1200 |          10 KB |    100M | 5s        |      2 MB |         57.6G |
| Comments (POST)   |        20 000 000 |     240 |           1 KB |      2M | 300ms     |    -      |       -       |
| Comments (GET)    |        20 000 000 |     240 |         100 KB |      2G | 2s        |    -      |       -       |
...
| Subscribes (GET)  |         1 000 000 |      12 |          10 KB |    120K | 2s        |    -      |       -       |
